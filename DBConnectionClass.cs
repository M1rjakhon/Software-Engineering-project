...
namespace GoFinApp
{
...

    {
        ...
        public void saveToDBClient(string sqlQuery,string FirstName, string LastName, string AddressLine1, string AddressLine2, string Postcode, string Email,
            string PhoneNumber, string PreferreContact, string ProductInterest, string RiskTolerence) // method the insert the data into the database 
        {
            using (connToDB = new SqlConnection(connStr))
            {
                ...
                sqlCommmand.Parameters.Add(new SqlParameter("FirstName", FirstName));
                sqlCommmand.Parameters.Add(new SqlParameter("LastName", LastName));
                sqlCommmand.Parameters.Add(new SqlParameter("AddressLine1", AddressLine1));
                sqlCommmand.Parameters.Add(new SqlParameter("AddressLine2", AddressLine2));
                sqlCommmand.Parameters.Add(new SqlParameter("Postcode", Postcode));
                sqlCommmand.Parameters.Add(new SqlParameter("Email", Email));
                sqlCommmand.Parameters.Add(new SqlParameter("PhoneNumber", PhoneNumber));
                sqlCommmand.Parameters.Add(new SqlParameter("PreferreContact", PreferreContact));
                sqlCommmand.Parameters.Add(new SqlParameter("ProductInterest", ProductInterest)); 
                sqlCommmand.Parameters.Add(new SqlParameter("RiskTolerence", RiskTolerence));
